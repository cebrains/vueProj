<template>
    <div class="inquiry-robot dialog">
        ...
        <div class="diagnoseCard"
            ...
            <div class='freeback pad3 toShowMedical' @click.stop='showMedication(stems)' id='inquiry_click_freeback'>
                <span class='icon-putaway'></span>
                查看用药方案
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState(['options', 'optionType', 'showPicker', 'conversationID', 'drugUsePlans','question']),
            recall() {
        ...
        methods: {
            ...
            clickCommand(e) {
                let {commandid, type, text,finish} = e.currentTarget.dataset,
                    ...
                    self = this;
                  this.$store.dispatch('setFinish',true);
